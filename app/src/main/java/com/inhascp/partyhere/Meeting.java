...
public class Meeting implements Serializable {
    private List<Boolean> meetingType;
    ...
    public Meeting(List<Boolean> meetingType, List<String> memberKeys, HashMap<String, String> memberKeyPlace, HashMap<String, String> recommendPlace, HashMap<String, String> memberKeyName, HashMap<String, List<Integer>> memberTransferTime) {
    ...
    public List<Boolean> getMeetingType() {
        return meetingType;
    }

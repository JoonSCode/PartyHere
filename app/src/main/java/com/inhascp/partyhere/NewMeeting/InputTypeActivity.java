    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMake.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<Boolean> mType = Arrays.asList(false, false, false, false, false);
                ...
                HashMap<String, Integer> meetingNumOfPerson = user.getMeetingNumOfPerson();
                meetingTitle.put(MeetingKey,mUserName);
                meetingNumOfPerson.put(MeetingKey, 1);
                updates.put("meetingTitle", meetingTitle);
                updates.put("meetingNumOfPerson", meetingNumOfPerson);
